...
ENDIF
IF ( SIZE( grid%dust_flux, 1 ) * SIZE( grid%dust_flux, 2 ) .GT. 1 ) THEN 
CALL interp_fcn (  &         
                  grid%dust_flux,   &       
...
ENDIF
IF ( SIZE( grid%seas_flux, 1 ) * SIZE( grid%seas_flux, 2 ) .GT. 1 ) THEN 
CALL interp_fcn (  &         
                  grid%seas_flux,   &       
                 cids, cide, 1, 1, cjds, cjde,   &         
                 cims, cime, 1, 1, cjms, cjme,   &         
...
ENDIF
IF ( SIZE( grid%actnh3, 1 ) * SIZE( grid%actnh3, 3 ) .GT. 1 ) THEN 
CALL interp_fcn (  &         
                  grid%actnh3,   &       
                 cids, cide, 1, 12, cjds, cjde,   &         
                 cims, cime, 1, 12, cjms, cjme,   &         
                 cips, cipe, 1, 12, cjps, cjpe,   &         
                  ngrid%actnh3,  &   
                 nids, nide, 1, 12, njds, njde,   &         
                 nims, nime, 1, 12, njms, njme,   &         
                 nips, nipe, 1, 12, njps, njpe,   &         
                  config_flags%shw, ngrid%imask_nostag,         &         
                  .FALSE., .FALSE.,                                                &         
                  ngrid%i_parent_start, ngrid%j_parent_start,                     &
                  ngrid%parent_grid_ratio, ngrid%parent_grid_ratio                &
...
ENDIF
IF ( SIZE( grid%agrisoil_nh3, 1 ) * SIZE( grid%agrisoil_nh3, 2 ) .GT. 1 ) THEN 
CALL interp_fcn (  &         
                  grid%agrisoil_nh3,   &       
                 cids, cide, 1, 1, cjds, cjde,   &         
                 cims, cime, 1, 1, cjms, cjme,   &         
...
ENDIF
IF ( SIZE( grid%fertilizer_nh3, 1 ) * SIZE( grid%fertilizer_nh3, 3 ) .GT. 1 ) THEN 
CALL interp_fcn (  &         
                  grid%fertilizer_nh3,   &       
                 cids, cide, 1, 12, cjds, cjde,   &         
                 cims, cime, 1, 12, cjms, cjme,   &         
                 cips, cipe, 1, 12, cjps, cjpe,   &         
                  ngrid%fertilizer_nh3,  &   
                 nids, nide, 1, 12, njds, njde,   &         
                 nims, nime, 1, 12, njms, njme,   &         
                 nips, nipe, 1, 12, njps, njpe,   &         
                  config_flags%shw, ngrid%imask_nostag,         &         
...
ENDIF
IF ( SIZE( grid%freeinten_nh3, 1 ) * SIZE( grid%freeinten_nh3, 2 ) .GT. 1 ) THEN 
CALL interp_fcn (  &         
                  grid%freeinten_nh3,   &       
                 cids, cide, 1, 1, cjds, cjde,   &         
                 cims, cime, 1, 1, cjms, cjme,   &         
...
ENDIF
IF ( SIZE( grid%graze_nh3, 1 ) * SIZE( grid%graze_nh3, 2 ) .GT. 1 ) THEN 
CALL interp_fcn (  &         
                  grid%graze_nh3,   &       
                 cids, cide, 1, 1, cjds, cjde,   &         
                 cims, cime, 1, 1, cjms, cjme,   &         
...
ENDIF
IF ( SIZE( grid%industry_nh3, 1 ) * SIZE( grid%industry_nh3, 2 ) .GT. 1 ) THEN 
CALL interp_fcn (  &         
                  grid%industry_nh3,   &       
                 cids, cide, 1, 1, cjds, cjde,   &         
                 cims, cime, 1, 1, cjms, cjme,   &         
...
ENDIF
IF ( SIZE( grid%residential_nh3, 1 ) * SIZE( grid%residential_nh3, 2 ) .GT. 1 ) THEN 
CALL interp_fcn (  &         
                  grid%residential_nh3,   &       
                 cids, cide, 1, 1, cjds, cjde,   &         
                 cims, cime, 1, 1, cjms, cjme,   &         
                 cips, cipe, 1, 1, cjps, cjpe,   &         
                  ngrid%residential_nh3,  &   
                 nids, nide, 1, 1, njds, njde,   &         
                 nims, nime, 1, 1, njms, njme,   &         
                 nips, nipe, 1, 1, njps, njpe,   &         
                  config_flags%shw, ngrid%imask_nostag,         &         
...
ENDIF
IF ( SIZE( grid%transport_nh3, 1 ) * SIZE( grid%transport_nh3, 2 ) .GT. 1 ) THEN 
CALL interp_fcn (  &         
                  grid%transport_nh3,   &       
                 cids, cide, 1, 1, cjds, cjde,   &         
                 cims, cime, 1, 1, cjms, cjme,   &         
...
ENDIF
IF ( SIZE( grid%erod_dri, 1 ) * SIZE( grid%erod_dri, 2 ) .GT. 1 ) THEN 
CALL interp_fcn (  &         
                  grid%erod_dri,   &       
...
ENDIF
IF ( SIZE( grid%wd_so4_sc, 1 ) * SIZE( grid%wd_so4_sc, 2 ) .GT. 1 ) THEN 
CALL interp_fcn (  &         
                  grid%wd_so4_sc,   &       
                 cids, cide, 1, 1, cjds, cjde,   &         
                 cims, cime, 1, 1, cjms, cjme,   &         
...
ENDIF
IF ( SIZE( grid%wd_no3_sc, 1 ) * SIZE( grid%wd_no3_sc, 2 ) .GT. 1 ) THEN 
CALL interp_fcn (  &         
                  grid%wd_no3_sc,   &       
                 cids, cide, 1, 1, cjds, cjde,   &         
                 cims, cime, 1, 1, cjms, cjme,   &         
...
ENDIF
IF ( SIZE( grid%wd_nh4_sc, 1 ) * SIZE( grid%wd_nh4_sc, 2 ) .GT. 1 ) THEN 
CALL interp_fcn (  &         
                  grid%wd_nh4_sc,   &       
                 cids, cide, 1, 1, cjds, cjde,   &         
                 cims, cime, 1, 1, cjms, cjme,   &         
...
ENDIF
IF ( SIZE( grid%wd_oa_sc, 1 ) * SIZE( grid%wd_oa_sc, 2 ) .GT. 1 ) THEN 
CALL interp_fcn (  &         
                  grid%wd_oa_sc,   &       
                 cids, cide, 1, 1, cjds, cjde,   &         
                 cims, cime, 1, 1, cjms, cjme,   &         
...
ENDIF
IF ( SIZE( grid%wd_so2_sc, 1 ) * SIZE( grid%wd_so2_sc, 2 ) .GT. 1 ) THEN 
CALL interp_fcn (  &         
                  grid%wd_so2_sc,   &       
                 cids, cide, 1, 1, cjds, cjde,   &         
                 cims, cime, 1, 1, cjms, cjme,   &         
...
ENDIF
IF ( SIZE( grid%wd_sulf_sc, 1 ) * SIZE( grid%wd_sulf_sc, 2 ) .GT. 1 ) THEN 
CALL interp_fcn (  &         
                  grid%wd_sulf_sc,   &       
                 cids, cide, 1, 1, cjds, cjde,   &         
                 cims, cime, 1, 1, cjms, cjme,   &         
...
ENDIF
IF ( SIZE( grid%wd_hno3_sc, 1 ) * SIZE( grid%wd_hno3_sc, 2 ) .GT. 1 ) THEN 
CALL interp_fcn (  &         
                  grid%wd_hno3_sc,   &       
                 cids, cide, 1, 1, cjds, cjde,   &         
                 cims, cime, 1, 1, cjms, cjme,   &         
...
ENDIF
IF ( SIZE( grid%wd_nh3_sc, 1 ) * SIZE( grid%wd_nh3_sc, 2 ) .GT. 1 ) THEN 
CALL interp_fcn (  &         
                  grid%wd_nh3_sc,   &       
                 cids, cide, 1, 1, cjds, cjde,   &         
                 cims, cime, 1, 1, cjms, cjme,   &         
...
ENDIF
IF ( SIZE( grid%wd_asoa_sc, 1 ) * SIZE( grid%wd_asoa_sc, 2 ) .GT. 1 ) THEN 
CALL interp_fcn (  &         
                  grid%wd_asoa_sc,   &       
                 cids, cide, 1, 1, cjds, cjde,   &         
                 cims, cime, 1, 1, cjms, cjme,   &         
...
ENDIF
IF ( SIZE( grid%wd_bsoa_sc, 1 ) * SIZE( grid%wd_bsoa_sc, 2 ) .GT. 1 ) THEN 
CALL interp_fcn (  &         
                  grid%wd_bsoa_sc,   &       
                 cids, cide, 1, 1, cjds, cjde,   &         
                 cims, cime, 1, 1, cjms, cjme,   &         
...
ENDIF
IF ( SIZE( grid%wd_cvasoa_sc, 1 ) * SIZE( grid%wd_cvasoa_sc, 2 ) .GT. 1 ) THEN 
CALL interp_fcn (  &         
                  grid%wd_cvasoa_sc,   &       
                 cids, cide, 1, 1, cjds, cjde,   &         
                 cims, cime, 1, 1, cjms, cjme,   &         
...
ENDIF
IF ( SIZE( grid%wd_cvbsoa_sc, 1 ) * SIZE( grid%wd_cvbsoa_sc, 2 ) .GT. 1 ) THEN 
CALL interp_fcn (  &         
                  grid%wd_cvbsoa_sc,   &       
                 cids, cide, 1, 1, cjds, cjde,   &         
                 cims, cime, 1, 1, cjms, cjme,   &         
...
ENDIF
IF ( SIZE( grid%wd_so4_cu, 1 ) * SIZE( grid%wd_so4_cu, 2 ) .GT. 1 ) THEN 
CALL interp_fcn (  &         
                  grid%wd_so4_cu,   &       
                 cids, cide, 1, 1, cjds, cjde,   &         
                 cims, cime, 1, 1, cjms, cjme,   &         
...
ENDIF
IF ( SIZE( grid%wd_no3_cu, 1 ) * SIZE( grid%wd_no3_cu, 2 ) .GT. 1 ) THEN 
CALL interp_fcn (  &         
                  grid%wd_no3_cu,   &       
                 cids, cide, 1, 1, cjds, cjde,   &         
                 cims, cime, 1, 1, cjms, cjme,   &         
...
ENDIF
IF ( SIZE( grid%wd_nh4_cu, 1 ) * SIZE( grid%wd_nh4_cu, 2 ) .GT. 1 ) THEN 
CALL interp_fcn (  &         
                  grid%wd_nh4_cu,   &       
                 cids, cide, 1, 1, cjds, cjde,   &         
                 cims, cime, 1, 1, cjms, cjme,   &         
...
ENDIF
IF ( SIZE( grid%wd_oa_cu, 1 ) * SIZE( grid%wd_oa_cu, 2 ) .GT. 1 ) THEN 
CALL interp_fcn (  &         
                  grid%wd_oa_cu,   &       
                 cids, cide, 1, 1, cjds, cjde,   &         
                 cims, cime, 1, 1, cjms, cjme,   &         
...
ENDIF
IF ( SIZE( grid%wd_so2_cu, 1 ) * SIZE( grid%wd_so2_cu, 2 ) .GT. 1 ) THEN 
CALL interp_fcn (  &         
                  grid%wd_so2_cu,   &       
                 cids, cide, 1, 1, cjds, cjde,   &         
                 cims, cime, 1, 1, cjms, cjme,   &         
...
ENDIF
IF ( SIZE( grid%wd_sulf_cu, 1 ) * SIZE( grid%wd_sulf_cu, 2 ) .GT. 1 ) THEN 
CALL interp_fcn (  &         
                  grid%wd_sulf_cu,   &       
                 cids, cide, 1, 1, cjds, cjde,   &         
                 cims, cime, 1, 1, cjms, cjme,   &         
...
ENDIF
IF ( SIZE( grid%wd_hno3_cu, 1 ) * SIZE( grid%wd_hno3_cu, 2 ) .GT. 1 ) THEN 
CALL interp_fcn (  &         
                  grid%wd_hno3_cu,   &       
                 cids, cide, 1, 1, cjds, cjde,   &         
                 cims, cime, 1, 1, cjms, cjme,   &         
...
ENDIF
IF ( SIZE( grid%wd_nh3_cu, 1 ) * SIZE( grid%wd_nh3_cu, 2 ) .GT. 1 ) THEN 
CALL interp_fcn (  &         
                  grid%wd_nh3_cu,   &       
                 cids, cide, 1, 1, cjds, cjde,   &         
                 cims, cime, 1, 1, cjms, cjme,   &         
...
ENDIF
IF ( SIZE( grid%wd_asoa_cu, 1 ) * SIZE( grid%wd_asoa_cu, 2 ) .GT. 1 ) THEN 
CALL interp_fcn (  &         
                  grid%wd_asoa_cu,   &       
                 cids, cide, 1, 1, cjds, cjde,   &         
                 cims, cime, 1, 1, cjms, cjme,   &         
...
ENDIF
IF ( SIZE( grid%wd_bsoa_cu, 1 ) * SIZE( grid%wd_bsoa_cu, 2 ) .GT. 1 ) THEN 
CALL interp_fcn (  &         
                  grid%wd_bsoa_cu,   &       
                 cids, cide, 1, 1, cjds, cjde,   &         
                 cims, cime, 1, 1, cjms, cjme,   &         
...
ENDIF
IF ( SIZE( grid%wd_cvasoa_cu, 1 ) * SIZE( grid%wd_cvasoa_cu, 2 ) .GT. 1 ) THEN 
CALL interp_fcn (  &         
                  grid%wd_cvasoa_cu,   &       
                 cids, cide, 1, 1, cjds, cjde,   &         
                 cims, cime, 1, 1, cjms, cjme,   &         
...
ENDIF
IF ( SIZE( grid%wd_cvbsoa_cu, 1 ) * SIZE( grid%wd_cvbsoa_cu, 2 ) .GT. 1 ) THEN 
CALL interp_fcn (  &         
                  grid%wd_cvbsoa_cu,   &       
                 cids, cide, 1, 1, cjds, cjde,   &         
                 cims, cime, 1, 1, cjms, cjme,   &         
