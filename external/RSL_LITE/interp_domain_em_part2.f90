...
IF ( SIZE( grid%qlsink, 1 ) * SIZE( grid%qlsink, 3 ) .GT. 1 ) THEN 
    CALL vert_interp_vert_nesting( &
                                  ...
                                  alt_u_c, alt_u_n ) 
ENDIF
IF ( SIZE( grid%precr, 1 ) * SIZE( grid%precr, 3 ) .GT. 1 ) THEN 
    CALL vert_interp_vert_nesting( &
                                  grid%precr, & 
                                  ids, ide, kds, kde, jds, jde, & 
                                  ims, ime, kms, kme, jms, jme, & 
                                  ...
                                  alt_u_c, alt_u_n ) 
ENDIF
IF ( SIZE( grid%preci, 1 ) * SIZE( grid%preci, 3 ) .GT. 1 ) THEN 
    CALL vert_interp_vert_nesting( &
                                  grid%preci, & 
                                  ids, ide, kds, kde, jds, jde, & 
                                  ims, ime, kms, kme, jms, jme, & 
                                  ...
                                  alt_u_c, alt_u_n ) 
ENDIF
IF ( SIZE( grid%precs, 1 ) * SIZE( grid%precs, 3 ) .GT. 1 ) THEN 
    CALL vert_interp_vert_nesting( &
                                  grid%precs, & 
                                  ids, ide, kds, kde, jds, jde, & 
                                  ims, ime, kms, kme, jms, jme, & 
                                  ...
                                  alt_u_c, alt_u_n ) 
ENDIF
IF ( SIZE( grid%precg, 1 ) * SIZE( grid%precg, 3 ) .GT. 1 ) THEN 
    CALL vert_interp_vert_nesting( &
                                  grid%precg, & 
                                  ids, ide, kds, kde, jds, jde, & 
                                  ims, ime, kms, kme, jms, jme, & 
