...
msize = (208 + ((num_wetscav_frcing - PARAM_FIRST_SCALAR + 1)) & 
 + ((num_emis_ant - PARAM_FIRST_SCALAR + 1)) & 
 + ((num_eghg_bio - PARAM_FIRST_SCALAR + 1)) & 
 + ((num_emis_dust - PARAM_FIRST_SCALAR + 1)) & 
 + ((num_emis_seas - PARAM_FIRST_SCALAR + 1)) & 
 + ((num_emis_seas2 - PARAM_FIRST_SCALAR + 1)) & 
 + ((num_emis_vol - PARAM_FIRST_SCALAR + 1)) & 
 + ((num_ebu - PARAM_FIRST_SCALAR + 1)) & 
 + ((num_ebu_in - PARAM_FIRST_SCALAR + 1)) & 
 + ((num_emis_aircraft - PARAM_FIRST_SCALAR + 1)) & 
 + ((num_ext_coef - PARAM_FIRST_SCALAR + 1)) & 
 + ((num_bscat_coef - PARAM_FIRST_SCALAR + 1)) & 
 + ((num_asym_par - PARAM_FIRST_SCALAR + 1)) & 
 + ((num_conv_ct - PARAM_FIRST_SCALAR + 1)) & 
 + ((num_chem_ct - PARAM_FIRST_SCALAR + 1)) & 
 + ((num_vmix_ct - PARAM_FIRST_SCALAR + 1)) & 
 + ((num_advh_ct - PARAM_FIRST_SCALAR + 1)) & 
 + ((num_advz_ct - PARAM_FIRST_SCALAR + 1)) & 
 + ((num_dvel - PARAM_FIRST_SCALAR + 1)) & 
 + ((num_aero_srf_area - PARAM_FIRST_SCALAR + 1)) & 
 + ((num_vprm_in - PARAM_FIRST_SCALAR + 1)) & 
 + ((num_wet_in - PARAM_FIRST_SCALAR + 1)) & 
 + ((num_chem - PARAM_FIRST_SCALAR + 1)) & 
 + ((num_tracer - PARAM_FIRST_SCALAR + 1)) & 
 + ((num_moist - PARAM_FIRST_SCALAR + 1)) & 
 ...
 + ((num_irr_diag_mozcart - PARAM_FIRST_SCALAR + 1)) & 
 + ((num_irr_diag_t1_mozcart - PARAM_FIRST_SCALAR + 1)) & 
 + ((num_irr_diag_mozart_mosaic_4bin - PARAM_FIRST_SCALAR + 1)) & 
 + ((num_irr_diag_mozart_mosaic_4bin_aq - PARAM_FIRST_SCALAR + 1)) )* nlev + 412
...
IF ( SIZE(grid%qlsink) .GT. 1 ) THEN 
DO k = ckds,(ckde-1)
xv(k)= intermediate_grid%qlsink(pig,k,pjg)
ENDDO
CALL rsl_lite_to_parent_msg((((ckde-1))-(ckds)+1)*4,xv)
ENDIF
IF ( SIZE(grid%precr) .GT. 1 ) THEN 
DO k = ckds,(ckde-1)
xv(k)= intermediate_grid%precr(pig,k,pjg)
ENDDO
CALL rsl_lite_to_parent_msg((((ckde-1))-(ckds)+1)*4,xv)
ENDIF
IF ( SIZE(grid%preci) .GT. 1 ) THEN 
DO k = ckds,(ckde-1)
xv(k)= intermediate_grid%preci(pig,k,pjg)
ENDDO
CALL rsl_lite_to_parent_msg((((ckde-1))-(ckds)+1)*4,xv)
ENDIF
IF ( SIZE(grid%precs) .GT. 1 ) THEN 
DO k = ckds,(ckde-1)
xv(k)= intermediate_grid%precs(pig,k,pjg)
ENDDO
CALL rsl_lite_to_parent_msg((((ckde-1))-(ckds)+1)*4,xv)
ENDIF
IF ( SIZE(grid%precg) .GT. 1 ) THEN 
DO k = ckds,(ckde-1)
xv(k)= intermediate_grid%precg(pig,k,pjg)
ENDDO
CALL rsl_lite_to_parent_msg((((ckde-1))-(ckds)+1)*4,xv)
ENDIF
IF ( SIZE(grid%dust_flux) .GT. 1 ) THEN 
xv(1)= intermediate_grid%dust_flux(pig,pjg)
CALL rsl_lite_to_parent_msg(4,xv)
ENDIF
IF ( SIZE(grid%seas_flux) .GT. 1 ) THEN 
xv(1)= intermediate_grid%seas_flux(pig,pjg)
CALL rsl_lite_to_parent_msg(4,xv)
ENDIF
IF ( SIZE(grid%erod_dri) .GT. 1 ) THEN 
DO k = 1,config_flags%erosion_dim
xv(k)= intermediate_grid%erod_dri(pig,pjg,k)
ENDDO
CALL rsl_lite_to_parent_msg(((config_flags%erosion_dim)-(1)+1)*4,xv)
ENDIF
IF ( SIZE(grid%wd_so4_sc) .GT. 1 ) THEN 
xv(1)= intermediate_grid%wd_so4_sc(pig,pjg)
CALL rsl_lite_to_parent_msg(4,xv)
ENDIF
IF ( SIZE(grid%wd_no3_sc) .GT. 1 ) THEN 
xv(1)= intermediate_grid%wd_no3_sc(pig,pjg)
CALL rsl_lite_to_parent_msg(4,xv)
ENDIF
IF ( SIZE(grid%wd_nh4_sc) .GT. 1 ) THEN 
xv(1)= intermediate_grid%wd_nh4_sc(pig,pjg)
CALL rsl_lite_to_parent_msg(4,xv)
ENDIF
IF ( SIZE(grid%wd_oa_sc) .GT. 1 ) THEN 
xv(1)= intermediate_grid%wd_oa_sc(pig,pjg)
CALL rsl_lite_to_parent_msg(4,xv)
ENDIF
IF ( SIZE(grid%wd_so2_sc) .GT. 1 ) THEN 
xv(1)= intermediate_grid%wd_so2_sc(pig,pjg)
CALL rsl_lite_to_parent_msg(4,xv)
ENDIF
IF ( SIZE(grid%wd_sulf_sc) .GT. 1 ) THEN 
xv(1)= intermediate_grid%wd_sulf_sc(pig,pjg)
CALL rsl_lite_to_parent_msg(4,xv)
ENDIF
IF ( SIZE(grid%wd_hno3_sc) .GT. 1 ) THEN 
xv(1)= intermediate_grid%wd_hno3_sc(pig,pjg)
CALL rsl_lite_to_parent_msg(4,xv)
ENDIF
IF ( SIZE(grid%wd_nh3_sc) .GT. 1 ) THEN 
xv(1)= intermediate_grid%wd_nh3_sc(pig,pjg)
CALL rsl_lite_to_parent_msg(4,xv)
ENDIF
IF ( SIZE(grid%wd_asoa_sc) .GT. 1 ) THEN 
xv(1)= intermediate_grid%wd_asoa_sc(pig,pjg)
CALL rsl_lite_to_parent_msg(4,xv)
ENDIF
IF ( SIZE(grid%wd_bsoa_sc) .GT. 1 ) THEN 
xv(1)= intermediate_grid%wd_bsoa_sc(pig,pjg)
CALL rsl_lite_to_parent_msg(4,xv)
ENDIF
IF ( SIZE(grid%wd_cvasoa_sc) .GT. 1 ) THEN 
xv(1)= intermediate_grid%wd_cvasoa_sc(pig,pjg)
CALL rsl_lite_to_parent_msg(4,xv)
ENDIF
IF ( SIZE(grid%wd_cvbsoa_sc) .GT. 1 ) THEN 
xv(1)= intermediate_grid%wd_cvbsoa_sc(pig,pjg)
CALL rsl_lite_to_parent_msg(4,xv)
ENDIF
IF ( SIZE(grid%wd_so4_cu) .GT. 1 ) THEN 
xv(1)= intermediate_grid%wd_so4_cu(pig,pjg)
CALL rsl_lite_to_parent_msg(4,xv)
ENDIF
IF ( SIZE(grid%wd_no3_cu) .GT. 1 ) THEN 
xv(1)= intermediate_grid%wd_no3_cu(pig,pjg)
CALL rsl_lite_to_parent_msg(4,xv)
ENDIF
IF ( SIZE(grid%wd_nh4_cu) .GT. 1 ) THEN 
xv(1)= intermediate_grid%wd_nh4_cu(pig,pjg)
CALL rsl_lite_to_parent_msg(4,xv)
ENDIF
IF ( SIZE(grid%wd_oa_cu) .GT. 1 ) THEN 
xv(1)= intermediate_grid%wd_oa_cu(pig,pjg)
CALL rsl_lite_to_parent_msg(4,xv)
ENDIF
IF ( SIZE(grid%wd_so2_cu) .GT. 1 ) THEN 
xv(1)= intermediate_grid%wd_so2_cu(pig,pjg)
CALL rsl_lite_to_parent_msg(4,xv)
ENDIF
IF ( SIZE(grid%wd_sulf_cu) .GT. 1 ) THEN 
xv(1)= intermediate_grid%wd_sulf_cu(pig,pjg)
CALL rsl_lite_to_parent_msg(4,xv)
ENDIF
IF ( SIZE(grid%wd_hno3_cu) .GT. 1 ) THEN 
xv(1)= intermediate_grid%wd_hno3_cu(pig,pjg)
CALL rsl_lite_to_parent_msg(4,xv)
ENDIF
IF ( SIZE(grid%wd_nh3_cu) .GT. 1 ) THEN 
xv(1)= intermediate_grid%wd_nh3_cu(pig,pjg)
CALL rsl_lite_to_parent_msg(4,xv)
ENDIF
IF ( SIZE(grid%wd_asoa_cu) .GT. 1 ) THEN 
xv(1)= intermediate_grid%wd_asoa_cu(pig,pjg)
CALL rsl_lite_to_parent_msg(4,xv)
ENDIF
IF ( SIZE(grid%wd_bsoa_cu) .GT. 1 ) THEN 
xv(1)= intermediate_grid%wd_bsoa_cu(pig,pjg)
CALL rsl_lite_to_parent_msg(4,xv)
ENDIF
IF ( SIZE(grid%wd_cvasoa_cu) .GT. 1 ) THEN 
xv(1)= intermediate_grid%wd_cvasoa_cu(pig,pjg)
CALL rsl_lite_to_parent_msg(4,xv)
ENDIF
IF ( SIZE(grid%wd_cvbsoa_cu) .GT. 1 ) THEN 
xv(1)= intermediate_grid%wd_cvbsoa_cu(pig,pjg)
CALL rsl_lite_to_parent_msg(4,xv)
ENDIF
DO itrace =  PARAM_FIRST_SCALAR, num_chem
DO k = ckds,(ckde-1)
xv(k)= intermediate_grid%chem(pig,k,pjg,itrace)
ENDDO
CALL rsl_lite_to_parent_msg((((ckde-1))-(ckds)+1)*4,xv)
ENDDO
...
IF ( cd_feedback_mask( pig, ips_save, ipe_save , pjg, jps_save, jpe_save, .FALSE., .FALSE. ) ) THEN
grid%dust_flux(pig,pjg) = xv(1)
ENDIF
ENDIF
IF ( SIZE(grid%seas_flux) .GT. 1 ) THEN 
CALL rsl_lite_from_child_msg(4,xv)
IF ( cd_feedback_mask( pig, ips_save, ipe_save , pjg, jps_save, jpe_save, .FALSE., .FALSE. ) ) THEN
grid%seas_flux(pig,pjg) = xv(1)
ENDIF
ENDIF
IF ( SIZE(grid%erod_dri) .GT. 1 ) THEN 
CALL rsl_lite_from_child_msg(((config_flags%erosion_dim)-(1)+1)*4,xv) ;
IF ( cd_feedback_mask( pig, ips_save, ipe_save , pjg, jps_save, jpe_save, .FALSE., .FALSE. ) ) THEN
DO k = 1,config_flags%erosion_dim
grid%erod_dri(pig,pjg,k) = xv(k)
ENDDO
ENDIF
ENDIF
IF ( SIZE(grid%wd_so4_sc) .GT. 1 ) THEN 
CALL rsl_lite_from_child_msg(4,xv)
IF ( cd_feedback_mask( pig, ips_save, ipe_save , pjg, jps_save, jpe_save, .FALSE., .FALSE. ) ) THEN
grid%wd_so4_sc(pig,pjg) = xv(1)
ENDIF
ENDIF
IF ( SIZE(grid%wd_no3_sc) .GT. 1 ) THEN 
CALL rsl_lite_from_child_msg(4,xv)
IF ( cd_feedback_mask( pig, ips_save, ipe_save , pjg, jps_save, jpe_save, .FALSE., .FALSE. ) ) THEN
grid%wd_no3_sc(pig,pjg) = xv(1)
ENDIF
ENDIF
IF ( SIZE(grid%wd_nh4_sc) .GT. 1 ) THEN 
CALL rsl_lite_from_child_msg(4,xv)
IF ( cd_feedback_mask( pig, ips_save, ipe_save , pjg, jps_save, jpe_save, .FALSE., .FALSE. ) ) THEN
grid%wd_nh4_sc(pig,pjg) = xv(1)
ENDIF
ENDIF
IF ( SIZE(grid%wd_oa_sc) .GT. 1 ) THEN 
CALL rsl_lite_from_child_msg(4,xv)
IF ( cd_feedback_mask( pig, ips_save, ipe_save , pjg, jps_save, jpe_save, .FALSE., .FALSE. ) ) THEN
grid%wd_oa_sc(pig,pjg) = xv(1)
ENDIF
ENDIF
IF ( SIZE(grid%wd_so2_sc) .GT. 1 ) THEN 
CALL rsl_lite_from_child_msg(4,xv)
IF ( cd_feedback_mask( pig, ips_save, ipe_save , pjg, jps_save, jpe_save, .FALSE., .FALSE. ) ) THEN
grid%wd_so2_sc(pig,pjg) = xv(1)
ENDIF
ENDIF
IF ( SIZE(grid%wd_sulf_sc) .GT. 1 ) THEN 
CALL rsl_lite_from_child_msg(4,xv)
IF ( cd_feedback_mask( pig, ips_save, ipe_save , pjg, jps_save, jpe_save, .FALSE., .FALSE. ) ) THEN
grid%wd_sulf_sc(pig,pjg) = xv(1)
ENDIF
ENDIF
IF ( SIZE(grid%wd_hno3_sc) .GT. 1 ) THEN 
CALL rsl_lite_from_child_msg(4,xv)
IF ( cd_feedback_mask( pig, ips_save, ipe_save , pjg, jps_save, jpe_save, .FALSE., .FALSE. ) ) THEN
grid%wd_hno3_sc(pig,pjg) = xv(1)
ENDIF
ENDIF
IF ( SIZE(grid%wd_nh3_sc) .GT. 1 ) THEN 
CALL rsl_lite_from_child_msg(4,xv)
IF ( cd_feedback_mask( pig, ips_save, ipe_save , pjg, jps_save, jpe_save, .FALSE., .FALSE. ) ) THEN
grid%wd_nh3_sc(pig,pjg) = xv(1)
ENDIF
ENDIF
IF ( SIZE(grid%wd_asoa_sc) .GT. 1 ) THEN 
CALL rsl_lite_from_child_msg(4,xv)
IF ( cd_feedback_mask( pig, ips_save, ipe_save , pjg, jps_save, jpe_save, .FALSE., .FALSE. ) ) THEN
grid%wd_asoa_sc(pig,pjg) = xv(1)
ENDIF
ENDIF
IF ( SIZE(grid%wd_bsoa_sc) .GT. 1 ) THEN 
CALL rsl_lite_from_child_msg(4,xv)
IF ( cd_feedback_mask( pig, ips_save, ipe_save , pjg, jps_save, jpe_save, .FALSE., .FALSE. ) ) THEN
grid%wd_bsoa_sc(pig,pjg) = xv(1)
ENDIF
ENDIF
IF ( SIZE(grid%wd_cvasoa_sc) .GT. 1 ) THEN 
CALL rsl_lite_from_child_msg(4,xv)
IF ( cd_feedback_mask( pig, ips_save, ipe_save , pjg, jps_save, jpe_save, .FALSE., .FALSE. ) ) THEN
grid%wd_cvasoa_sc(pig,pjg) = xv(1)
ENDIF
ENDIF
IF ( SIZE(grid%wd_cvbsoa_sc) .GT. 1 ) THEN 
CALL rsl_lite_from_child_msg(4,xv)
IF ( cd_feedback_mask( pig, ips_save, ipe_save , pjg, jps_save, jpe_save, .FALSE., .FALSE. ) ) THEN
grid%wd_cvbsoa_sc(pig,pjg) = xv(1)
ENDIF
ENDIF
IF ( SIZE(grid%wd_so4_cu) .GT. 1 ) THEN 
CALL rsl_lite_from_child_msg(4,xv)
IF ( cd_feedback_mask( pig, ips_save, ipe_save , pjg, jps_save, jpe_save, .FALSE., .FALSE. ) ) THEN
grid%wd_so4_cu(pig,pjg) = xv(1)
ENDIF
ENDIF
IF ( SIZE(grid%wd_no3_cu) .GT. 1 ) THEN 
CALL rsl_lite_from_child_msg(4,xv)
IF ( cd_feedback_mask( pig, ips_save, ipe_save , pjg, jps_save, jpe_save, .FALSE., .FALSE. ) ) THEN
grid%wd_no3_cu(pig,pjg) = xv(1)
ENDIF
ENDIF
IF ( SIZE(grid%wd_nh4_cu) .GT. 1 ) THEN 
CALL rsl_lite_from_child_msg(4,xv)
IF ( cd_feedback_mask( pig, ips_save, ipe_save , pjg, jps_save, jpe_save, .FALSE., .FALSE. ) ) THEN
grid%wd_nh4_cu(pig,pjg) = xv(1)
ENDIF
ENDIF
IF ( SIZE(grid%wd_oa_cu) .GT. 1 ) THEN 
CALL rsl_lite_from_child_msg(4,xv)
IF ( cd_feedback_mask( pig, ips_save, ipe_save , pjg, jps_save, jpe_save, .FALSE., .FALSE. ) ) THEN
grid%wd_oa_cu(pig,pjg) = xv(1)
ENDIF
ENDIF
IF ( SIZE(grid%wd_so2_cu) .GT. 1 ) THEN 
CALL rsl_lite_from_child_msg(4,xv)
IF ( cd_feedback_mask( pig, ips_save, ipe_save , pjg, jps_save, jpe_save, .FALSE., .FALSE. ) ) THEN
grid%wd_so2_cu(pig,pjg) = xv(1)
ENDIF
ENDIF
IF ( SIZE(grid%wd_sulf_cu) .GT. 1 ) THEN 
CALL rsl_lite_from_child_msg(4,xv)
IF ( cd_feedback_mask( pig, ips_save, ipe_save , pjg, jps_save, jpe_save, .FALSE., .FALSE. ) ) THEN
grid%wd_sulf_cu(pig,pjg) = xv(1)
ENDIF
ENDIF
IF ( SIZE(grid%wd_hno3_cu) .GT. 1 ) THEN 
CALL rsl_lite_from_child_msg(4,xv)
IF ( cd_feedback_mask( pig, ips_save, ipe_save , pjg, jps_save, jpe_save, .FALSE., .FALSE. ) ) THEN
grid%wd_hno3_cu(pig,pjg) = xv(1)
ENDIF
ENDIF
IF ( SIZE(grid%wd_nh3_cu) .GT. 1 ) THEN 
CALL rsl_lite_from_child_msg(4,xv)
IF ( cd_feedback_mask( pig, ips_save, ipe_save , pjg, jps_save, jpe_save, .FALSE., .FALSE. ) ) THEN
grid%wd_nh3_cu(pig,pjg) = xv(1)
ENDIF
ENDIF
IF ( SIZE(grid%wd_asoa_cu) .GT. 1 ) THEN 
CALL rsl_lite_from_child_msg(4,xv)
IF ( cd_feedback_mask( pig, ips_save, ipe_save , pjg, jps_save, jpe_save, .FALSE., .FALSE. ) ) THEN
grid%wd_asoa_cu(pig,pjg) = xv(1)
ENDIF
ENDIF
IF ( SIZE(grid%wd_bsoa_cu) .GT. 1 ) THEN 
CALL rsl_lite_from_child_msg(4,xv)
IF ( cd_feedback_mask( pig, ips_save, ipe_save , pjg, jps_save, jpe_save, .FALSE., .FALSE. ) ) THEN
grid%wd_bsoa_cu(pig,pjg) = xv(1)
ENDIF
ENDIF
IF ( SIZE(grid%wd_cvasoa_cu) .GT. 1 ) THEN 
CALL rsl_lite_from_child_msg(4,xv)
IF ( cd_feedback_mask( pig, ips_save, ipe_save , pjg, jps_save, jpe_save, .FALSE., .FALSE. ) ) THEN
grid%wd_cvasoa_cu(pig,pjg) = xv(1)
ENDIF
ENDIF
IF ( SIZE(grid%wd_cvbsoa_cu) .GT. 1 ) THEN 
CALL rsl_lite_from_child_msg(4,xv)
IF ( cd_feedback_mask( pig, ips_save, ipe_save , pjg, jps_save, jpe_save, .FALSE., .FALSE. ) ) THEN
grid%wd_cvbsoa_cu(pig,pjg) = xv(1)
ENDIF
ENDIF
DO itrace =  PARAM_FIRST_SCALAR, num_chem
CALL rsl_lite_from_child_msg((((ckde-1))-(ckds)+1)*4,xv) ;
